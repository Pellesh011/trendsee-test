...
<br>
<br>
Теперь быстро: как сделать, чтобы не скатывалось.<br>
Убери один слой под SPF — оставь либо сыворотку, либо крем, не всё вместе.<br>
Наноси тонким слоем, без “массажа”.<br>
И не трогай лицо сразу после нанесения.<br>
<br>
<br>
